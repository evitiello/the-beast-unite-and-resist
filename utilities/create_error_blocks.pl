...
sub clean_blocks() {
	open INPUT, "<errors.txt";
	while (<INPUT>) {
		my @this_data = split(/\:\:/,$_);
		#print "$this_data[5] $this_data[6]\n";
...
INSERT INTO blocks (
	...
	$this_data[5],$this_data[5],$this_data[6],$this_data[6],
	64575,64575,65535,65535,43690,43690,12,12,9,9,13,13
)
END

	my $sql_2 = "DELETE results WHERE entry_22=$this_data[5] AND entry_23=$this_data[6]";
